...
import { INukleusNetworkInfo } from "./INukleusNetworkInfo.sol";
import { INukleusNetwork } from "./INukleusNetwork.sol";
 ...
 */
interface INukleusNetworkInfo is IUpgradeable {
    /**
     * @dev returns the network contract
     */
    function network() external view returns (INukleusNetwork);
