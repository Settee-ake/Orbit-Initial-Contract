...
struct PoolLiquidity {
    uint128 nukleusTradingLiquidity; // the Nukleus trading liquidity
...
struct TradeAmountAndFee {
    ...
    uint256 networkFeeAmount; // the network fee amount (always in units of Nukleus)
}
...
interface IPoolCollection is IVersioned {
     ...
     * along with the breakdown of the base token and the Nukleus compensation
     */
